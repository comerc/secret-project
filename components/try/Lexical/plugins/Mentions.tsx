...
// TODO: @ пропадает при переключении в markdown, нужно сдеделать, как в GitHub - по нику
...
function MentionsPlugin(): JSX.Element | null {
      ...
      menuRenderFn={(
        ...
        anchorElementRef.current && results.length
          ? ReactDOM.createPortal(
              <div className={`${styles['typeahead-popover']} ${styles['mentions-menu']}`}>
                <ul>
