...
function ComponentPickerPlugin(): JSX.Element {
    ...
    const baseOptions = [
      ...
      new ComponentPickerOption('Image', {
        ...
        onSelect: () => {
          showModal({
            title: 'Insert Image',
            getBody: (close) => <InsertImageDialog activeEditor={editor} close={close} />,
          })
        },
      }),
        ...
        menuRenderFn={(
          ...
          anchorElementRef.current && options.length
            ? ReactDOM.createPortal(
                <div
                  className={`${styles['typeahead-popover']} ${styles['component-picker-menu']}`}
                >
                  <ul>
